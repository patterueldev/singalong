...
class GenericServiceUseCaseTest {
    ...
    @Test
    fun execute_withPositiveParameter_returnsSuccessResponse() =
        runBlocking {
    ...
    @Test
    fun execute_withNegativeParameter_returnsFailureResponse() =
        runBlocking {
            val useCase = TestGenericServiceUseCase()
    ...
    @Test
    fun execute_withZeroParameter_returnsSuccessResponse() =
        runBlocking {
            val useCase = TestGenericServiceUseCase()
