...
class ServiceUseCaseTest {
    ...
    @Test
    fun execute_returnsExpectedResult() =
        runBlocking {
    ...
    @Test
    fun invokeOperator_returnsExpectedResult() =
        runBlocking {
            val useCase = TestServiceUseCase()
    ...
    @Test
    fun execute_withNegativeParameter_returnsExpectedResult() =
        runBlocking {
            val useCase = TestServiceUseCase()
    ...
    @Test
    fun execute_withZeroParameter_returnsExpectedResult() =
        runBlocking {
            val useCase = TestServiceUseCase()
