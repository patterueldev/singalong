...
class RoomUserRepositoryTest {
    ...
    @Test
    fun currentUser_returnsValidRoomUser() = runBlocking {
        val roomUser = object : RoomUser {
    ...
    @Test
    fun currentUser_withEmptyUsername_returnsRoomUserWithEmptyUsername() = runBlocking {
        val roomUser = object : RoomUser {
    ...
    @Test
    fun currentUser_withEmptyRoomId_returnsRoomUserWithEmptyRoomId() = runBlocking {
        val roomUser = object : RoomUser {
            override val username = "user1"
            override val roomId = ""
        }
    ...
    @Test
    fun currentUser_withEmptyUsernameAndRoomId_returnsRoomUserWithEmptyValues() = runBlocking {
        val roomUser = object : RoomUser {
            override val username = ""
            override val roomId = ""
        }
