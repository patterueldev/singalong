...
open class PaginatedData<T>(
    ...
    companion object {
        ...
        fun <T> withNextOffset(data: List<T>, nextOffset: Int): PaginatedData<T> {
            return PaginatedData(data, nextOffset, null, null)
        }
        fun <T> withNextCursor(data: List<T>, nextCursor: String): PaginatedData<T> {
            return PaginatedData(data, null, nextCursor, null)
        }
        fun <T> withNextPage(data: List<T>, nextPage: Int): PaginatedData<T> {
